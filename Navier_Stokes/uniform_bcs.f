...
!***********************************************************************
      ...
      subroutine uniform_bcs(u_bc_ew, u_bc_ns,
     &                       v_bc_ew, v_bc_ns,
     &                         nx, ny, dx, dy)

c uniform  bc conditions
c u,v = 1 all around the boundary
...
c      write(*,*) 'vel',vel
      ...
      do j = 1, ny
       ...
       u_bc_ew(j,2) = vel !east
       v_bc_ew(j,2) = vel !0.d0 
      ...
      do i = 1, nx
        ...
        u_bc_ns(i,2) =  vel ! north 
        v_bc_ns(i,2) =  vel !0.d0 
