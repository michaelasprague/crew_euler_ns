...
!***********************************************************************
      ...
      subroutine add_ke2( u_bc_ew, u_bc_ns, v_bc_ew, v_bc_ns,
...
c integral c1
     ...
     &     ( ue_bc_ns(i,1)**2.d0 + ve_bc_ns(i,1)**2.d0 )   !south
     &     + dx_n * re_bc_ns(i,2) *
     &     ( ue_bc_ns(i,2)**2.d0 + ve_bc_ns(i,2)**2.d0 )   !north

c integral c2

        c2 = c2 +  
     &    dx_n * ( u_bc_ns(i,1)**2.d0 + v_bc_ns(i,1)**2.d0 )   !south
     &  + dx_n * ( u_bc_ns(i,2)**2.d0 + v_bc_ns(i,2)**2.d0 )   !north
...
c integral c1
     ...
     &     ( ue_bc_ew(j,1)**2.d0 + ve_bc_ew(j,1)**2.d0 )   !west
     &    + dy_n * re_bc_ew(j,2) *
     &     ( ue_bc_ew(j,2)**2.d0 + ve_bc_ew(j,2)**2.d0 )   !east

c integral c2

        c2 = c2 +  
     &     dy_n * ( u_bc_ew(j,1)**2.d0 + v_bc_ew(j,1)**2.d0 )   !west
     &   + dy_n * ( u_bc_ew(j,2)**2.d0 + v_bc_ew(j,2)**2.d0 )   !east
